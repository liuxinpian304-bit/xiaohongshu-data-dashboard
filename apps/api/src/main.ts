...
import { AccountDeletionDto, AccountDto, AccountStateDto, AuthCsrfResponseDto, AuthLoginResponseDto, AuthorizeAccountDto, BackgroundExportDto, CommentDto, ConnectorCapabilityDto, CreateJobDto, DashboardCardDto, DashboardDailyRowDto, DashboardMetricDeltaDto, DashboardRankedNoteDto, DashboardResponseDto, DashboardTrendPointDto, DeleteAccountDto, ErrorDto, LoginDto, MissingReportFieldDto, NoteDto, NotificationDto, OkResponseDto, PageInfoDto, PushSubscriptionRequestDto, PushSubscriptionResponseDto, ReportDto, ReportEvidenceRefDto, ReportMetricDto, ReauthorizeAccountDto, SyncJobDto } from './common/api.dto';
...
export function configureApp(app: INestApplication) {
  ...
  const models = [LoginDto, AuthorizeAccountDto, ReauthorizeAccountDto, DeleteAccountDto, CreateJobDto, PushSubscriptionRequestDto, ErrorDto, PageInfoDto, ConnectorCapabilityDto, AccountDto, SyncJobDto, NoteDto, CommentDto, MissingReportFieldDto, ReportEvidenceRefDto, ReportMetricDto, ReportDto, NotificationDto, DashboardCardDto, DashboardTrendPointDto, DashboardMetricDeltaDto, DashboardDailyRowDto, DashboardRankedNoteDto, DashboardResponseDto, AuthCsrfResponseDto, AuthLoginResponseDto, OkResponseDto, AccountStateDto, AccountDeletionDto, PushSubscriptionResponseDto, BackgroundExportDto];
  ...
  addParameters('/dashboard', [['period', 'query', false, undefined, ['daily', 'weekly', 'monthly']], ['accountId', 'query', false, 'uuid'], ['source', 'query', false, undefined, ['official', 'self-scrape']]]);
