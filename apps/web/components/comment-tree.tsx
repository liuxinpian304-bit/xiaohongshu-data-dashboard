...
export type CommentItem = { id: string; platformId: string; parentPlatformId: string | null; content: string; publishedAt: string; likeCount: number };
